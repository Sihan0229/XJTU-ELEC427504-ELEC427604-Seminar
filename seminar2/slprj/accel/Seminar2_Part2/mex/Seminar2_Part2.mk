...
MODEL                = Seminar2_Part2
MODULES              = Seminar2_Part2_acc.c Seminar2_Part2_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/Seminar2_Part2_acc.mexw64
MAKEFILE             = Seminar2_Part2.mk
MATLAB_ROOT          = D:/MATLAB
ALT_MATLAB_ROOT      = D:/MATLAB
START_DIR            = D:/xjtufiles/2023-2024/power_electronics/seminar2
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 36
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/Seminar2_Part2 \
...
Seminar2_Part2_acc.obj : $(START_DIR)/slprj/accel/Seminar2_Part2/Seminar2_Part2_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/Seminar2_Part2/Seminar2_Part2_acc.c

Seminar2_Part2_acc_data.obj : $(START_DIR)/slprj/accel/Seminar2_Part2/Seminar2_Part2_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/Seminar2_Part2/Seminar2_Part2_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/Seminar2_Part2/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/Seminar2_Part2/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/Seminar2_Part2/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/Seminar2_Part2/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/Seminar2_Part2/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/Seminar2_Part2/rt_nonfinite.c
